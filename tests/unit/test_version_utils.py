...
def test_get_full_version_returns_metadata(monkeypatch):
    ...
    monkeypatch.setattr(version_utils, 'version', lambda package: expected_version)
...
def test_get_major_minor_version_returns_two_components(monkeypatch):
    ...
    monkeypatch.setattr(version_utils, 'get_full_version', lambda: '2.3.4')
...
def test_dunder_version_matches_full_version(monkeypatch):
    ...
    monkeypatch.setattr(importlib_metadata, 'version', lambda package: expected_version)
